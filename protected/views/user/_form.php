...
<div class="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
    <h2 class="text-2xl font-bold text-gray-800 mb-6"><?php echo ($user->isNewRecord) ? "Create New User" : "Update Existing User" ?></h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <?php echo $form->passwordField($user, 'password', array(
                    'class' => 'w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500',
                    'placeholder' => ($user->isNewRecord) ? 'Enter password' : 'Leave blank to keep current password'
                )); ?>
    ...
    <div class="bg-blue-50 p-4 rounded-lg">
        ...
        <div>
            ...
            <select <?php if(!$user->isNewRecord) echo "disabled" ?> id="user-type-select" name="User[role]" <?php if (isset($user) && $user->role) echo 'value="' . $user->role . '"'; ?> class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
